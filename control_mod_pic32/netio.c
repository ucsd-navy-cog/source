...
//#else
//  SPI2CON1bits.SPRE = 0b110; //1:2 for RX
//#endif
//
...
//  SPI2STATbits.SPIEN = 1;
  ...
  //nRF2 pins
  //CE and CSN uses nRF1 pins
  TRISDbits.TRISD4 = 0;
  TRISDbits.TRISD5 = 0;
  TRISDbits.TRISD10 = 1;

  //still need to clear buffers and overflow?
  SPI3CONbits.ON = 0;
  SPI3CONbits.MSSEN = 0;
...
#else
  //SPI2 pins
  TRISGbits.TRISG7 = 1; //nRF_MI
  TRISGbits.TRISG8 = 0; //nRF_MO
  TRISGbits.TRISG6 = 0; //nRF_SCK

  //nRF pins
  TRISEbits.TRISE5 = 0; //nRF_CE
  TRISEbits.TRISE6 = 0; //nRF_CSN
  TRISDbits.TRISD8 = 1; //nRF_IRQ  
